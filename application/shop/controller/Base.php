...
use think\Db;
use \think\Session;
use app\shop\model\CardLog;
use app\shop\model\ConsumptionLog;
use app\shop\model\MsgLog;
...
class Base extends Controller
{
	...
	public function _initialize()
    {
    	$request = request();
		//session存在时，不需要验证的权限
		$not_check = array('shop/login','shop/lost_password','shop/getphonebycoupons','shop/getcoupons');
		//当前操作的请求 模块名/方法名
