...
use \think\Session;
use think\Request;
use app\professional\model\MarryCase as MarryCaseModel;
use app\professional\model\MarryCasePic;
use app\professional\model\Picture;
...
class MarryCase extends Base
{
    ...
    function edit(){
		...
		//登录账号
		$marry_case = MarryCaseModel::get($id);
		$this->assign('marry_case',$marry_case);
		//图片
		$mc_pic = MarryCasePic::where(['marry_id'=>$id])->find();
